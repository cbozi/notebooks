...
## <a id="user-content-让-http-支持双向通信"></a>[](#让-http-支持双向通信)让 HTTP 支持双向通信
...
## <a id="user-content-websockets-的出现"></a>[](#websockets-的出现)WebSockets 的出现
...
[![](https://user-images.githubusercontent.com/1475173/39884220-a86a093a-54bb-11e8-8cd4-fac1e27f4813.png)](https://user-images.githubusercontent.com/1475173/39884220-a86a093a-54bb-11e8-8cd4-fac1e27f4813.png)
...
## <a id="user-content-websocket-地址"></a>[](#websocket-地址)WebSocket 地址
...
## <a id="user-content-帧协议"></a>[](#帧协议)帧协议
...
## <a id="user-content-帧数据"></a>[](#帧数据)帧数据
...
[![](https://user-images.githubusercontent.com/1475173/39884275-e9287a6a-54bb-11e8-9386-b8ec0c4dc58c.png)](https://user-images.githubusercontent.com/1475173/39884275-e9287a6a-54bb-11e8-9386-b8ec0c4dc58c.png)

## <a id="user-content-数据分片"></a>[](#数据分片)数据分片
...
## <a id="user-content-心跳包"></a>[](#心跳包)心跳包
...
## <a id="user-content-关闭连接"></a>[](#关闭连接)关闭连接
...
## <a id="user-content-websockets-和-http2-对比"></a>[](#websockets-和-http2-对比)WebSockets 和 HTTP/2 对比
...
[![](https://user-images.githubusercontent.com/1475173/39884335-22403eb4-54bc-11e8-9ec2-3e89827c7b8c.png)](https://user-images.githubusercontent.com/1475173/39884335-22403eb4-54bc-11e8-9ec2-3e89827c7b8c.png)
...
[![](https://user-images.githubusercontent.com/1475173/39884369-3749d112-54bc-11e8-8dc0-e07733b74e56.png)](https://user-images.githubusercontent.com/1475173/39884369-3749d112-54bc-11e8-8dc0-e07733b74e56.png)
...
## <a id="user-content-websocket-和-http2-的使用场景"></a>[](#websocket-和-http2-的使用场景)WebSocket 和 HTTP/2 的使用场景
...
[![](https://user-images.githubusercontent.com/1475173/39884410-54d4a8b0-54bc-11e8-8369-9763917c8fa1.png)](https://user-images.githubusercontent.com/1475173/39884410-54d4a8b0-54bc-11e8-8369-9763917c8fa1.png)

兼容性还不错。

然而，HTTP/2 的情况就不太妙了：

[![](https://user-images.githubusercontent.com/1475173/39884447-753df098-54bc-11e8-9964-ec78572da12e.png)](https://user-images.githubusercontent.com/1475173/39884447-753df098-54bc-11e8-9964-ec78572da12e.png)
...
[![](https://user-images.githubusercontent.com/1475173/39884473-8a06d404-54bc-11e8-8357-100e6be31db5.png)](https://user-images.githubusercontent.com/1475173/39884473-8a06d404-54bc-11e8-8357-100e6be31db5.png)

仅 IE/Edge 不支持。（好吧，Opera Mini 即不支持 SSE 也不支持 WebSockets，因此我们把它完全排队在外）。有一些优雅的垫片来让 IE/Edge 支持 SSE。

## <a id="user-content-sessionstack-是如何选择的"></a>[](#sessionstack-是如何选择的)SessionStack 是如何选择的？
