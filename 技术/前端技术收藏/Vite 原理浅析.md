...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1052" height="346"></svg>)
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="751"></svg>)
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="801"></svg>)

注意这张图里的代码区第一句话 `import { updateStyle } from '/@hmr'`，并且在左侧请求列表中也有一个对 `@hmr` 文件的请求。这个请求是啥呢？

![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="357"></svg>)
