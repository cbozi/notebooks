...
![](../../_resources/2a35a638dcf14f2183deb0abdf88ca9d.png)
...
![](../../_resources/ae11b3ddadec486383e46aa94a8bc497.png)
...
<img width="694" height="694" src="../../_resources/23c77241a6154e94865b15f34ed90eb2.gif"/>

## 5.1. <a id="browserAction(浏览器右上角)"></a>browserAction(浏览器右上角)
...
### 5.1.2. <a id="tooltip"></a>tooltip

修改`browser_action`的manifest中`default_title`字段，或者调用`setTitle()`方法。

<img width="197" height="197" src="../../_resources/23c77241a6154e94865b15f34ed90eb2.gif"/>

### 5.1.3. <a id="badge"></a>badge
...
<img width="179" height="179" src="../../_resources/23c77241a6154e94865b15f34ed90eb2.gif"/>

## 5.2. <a id="pageAction(地址栏右侧)"></a>pageAction(地址栏右侧)
...
<img width="652" height="652" src="../../_resources/23c77241a6154e94865b15f34ed90eb2.gif"/>

而新版的Chrome更改了这一策略，pageAction和普通的browserAction一样也是放在浏览器右上角，只不过没有点亮时是灰色的，点亮了才是彩色的，灰色时无论左键还是右键单击都是弹出选项：

<img width="364" height="364" src="../../_resources/23c77241a6154e94865b15f34ed90eb2.gif"/>
...
<img width="590" height="590" src="../../_resources/23c77241a6154e94865b15f34ed90eb2.gif"/>

## 5.3. <a id="右键菜单"></a>右键菜单
...
<img width="644" height="644" src="../../_resources/23c77241a6154e94865b15f34ed90eb2.gif"/>

### 5.3.1. <a id="最简单的右键菜单示例"></a>最简单的右键菜单示例
...
<img width="348" height="348" src="../../_resources/23c77241a6154e94865b15f34ed90eb2.gif"/>

### 5.3.2. <a id="添加右键百度搜索"></a>添加右键百度搜索
...
<img width="450" height="450" src="../../_resources/23c77241a6154e94865b15f34ed90eb2.gif"/>

### 5.3.3. <a id="语法说明"></a>语法说明
...
## 5.4. <a id="override(覆盖特定页面)"></a>override(覆盖特定页面)
...
<img width="659" height="659" src="../../_resources/23c77241a6154e94865b15f34ed90eb2.gif"/>
...
<img width="995" height="995" src="../../_resources/23c77241a6154e94865b15f34ed90eb2.gif"/>
...
<img width="922" height="922" src="../../_resources/23c77241a6154e94865b15f34ed90eb2.gif"/>

自定义侧边栏（获取当前页面所有图片）：

<img width="525" height="525" src="../../_resources/23c77241a6154e94865b15f34ed90eb2.gif"/>

### 5.5.2. <a id="devtools扩展介绍"></a>devtools扩展介绍
...
<img width="381" height="381" src="../../_resources/23c77241a6154e94865b15f34ed90eb2.gif"/>

以下截图示例的代码：

<img width="244" height="244" src="../../_resources/23c77241a6154e94865b15f34ed90eb2.gif"/>
...
## 5.6. <a id="option(选项页)"></a>option(选项页)

所谓`options`页，就是插件的设置页面，有2个入口，一个是右键图标有一个“选项”菜单，还有一个在插件管理页面：

<img width="192" height="192" src="../../_resources/23c77241a6154e94865b15f34ed90eb2.gif"/>

<img width="463" height="463" src="../../_resources/23c77241a6154e94865b15f34ed90eb2.gif"/>
...
<img width="625" height="625" src="../../_resources/23c77241a6154e94865b15f34ed90eb2.gif"/>
...
<img width="757" height="757" src="../../_resources/23c77241a6154e94865b15f34ed90eb2.gif"/>
...
<img width="383" height="383" src="../../_resources/23c77241a6154e94865b15f34ed90eb2.gif"/>
...
<img width="354" height="354" src="../../_resources/23c77241a6154e94865b15f34ed90eb2.gif"/>
...
## 6.2. <a id="调试方式对比"></a>调试方式对比

| JS类型 | 调试方式 | 图片说明 |
| --- | --- | --- |
| injected script | 直接普通的F12即可 | 懒得截图 |
| content-script | 打开Console,如图切换 | <img width="470" height="470" src="../../_resources/23c77241a6154e94865b15f34ed90eb2.gif"/> |
| popup-js | popup页面右键审查元素 | <img width="318" height="318" src="../../_resources/23c77241a6154e94865b15f34ed90eb2.gif"/> |
| background | 插件管理页点击背景页即可 | <img width="486" height="486" src="../../_resources/23c77241a6154e94865b15f34ed90eb2.gif"/> |
...
bg.test(); alert(bg.document.body.innerHTML); 
```
...
## 8.1. <a id="动态注入或执行JS"></a>动态注入或执行JS
...
## 8.4. <a id="获取当前标签页ID"></a>获取当前标签页ID
...
<img width="385" height="385" src="../../_resources/23c77241a6154e94865b15f34ed90eb2.gif"/>
...
<img width="788" height="788" src="../../_resources/23c77241a6154e94865b15f34ed90eb2.gif"/>
...
<img width="422" height="422" src="../../_resources/23c77241a6154e94865b15f34ed90eb2.gif"/>

英文效果：

<img width="492" height="492" src="../../_resources/23c77241a6154e94865b15f34ed90eb2.gif"/>

中文效果：

<img width="507" height="507" src="../../_resources/23c77241a6154e94865b15f34ed90eb2.gif"/>
...
## 9.1. <a id="chrome.cookies"></a>chrome.cookies
...
<img width="550" height="550" src="../../_resources/23c77241a6154e94865b15f34ed90eb2.gif"/>

如何查看某个插件的ID？进入 chrome://extensions ，然后勾线开发者模式即可看到了。

<img width="730" height="730" src="../../_resources/23c77241a6154e94865b15f34ed90eb2.gif"/>
...
<img width="334" height="334" src="../../_resources/23c77241a6154e94865b15f34ed90eb2.gif"/>

打包的话直接在插件管理页有一个打包按钮：

<img width="573" height="573" src="../../_resources/23c77241a6154e94865b15f34ed90eb2.gif"/>

然后会生成一个`.crx`文件，要发布到Google应用商店的话需要先登录你的Google账号，然后花5个$注册为开发者，本人太穷，就懒得亲自验证了，有发布需求的自己去整吧。

<img width="482" height="482" src="../../_resources/23c77241a6154e94865b15f34ed90eb2.gif"/>

## 12.1. <a id="官方资料"></a>官方资料
...
<img width="512" height="512" src="../../_resources/23c77241a6154e94865b15f34ed90eb2.gif"/>