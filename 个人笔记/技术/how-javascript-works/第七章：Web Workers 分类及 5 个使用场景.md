...
## <a id="user-content-异步编程的局限性"></a>[](#异步编程的局限性)异步编程的局限性
...
## <a id="user-content-web-workders-来救场"></a>[](#web-workders-来救场)Web Workders 来救场
...
## <a id="user-content-web-workers-概览"></a>[](#web-workers-概览)Web Workers 概览
...
## <a id="user-content-dedicated-workers"></a>[](#dedicated-workers)Dedicated Workers

Dedicated Web Workers 是由主进程实例化并且只能与之进行通信

[<img width="1012" height="368" src="../../../_resources/2a499efce003490cbefe84a992d384a2.png"/>](https://user-images.githubusercontent.com/1475173/40270200-7324ac2e-5bbb-11e8-80d6-654e0e0b5dfb.png)
...
[<img width="1012" height="389" src="../../../_resources/88ecd1e96beb411e982bdce4dd6e0b7c.png"/>](https://user-images.githubusercontent.com/1475173/40270199-72b94baa-5bbb-11e8-9755-541047f8e93a.png)

Shared Workers 浏览器支持情况

## <a id="user-content-service-workers"></a>[](#service-workers)Service Workers

Service Worker 是一个由事件驱动的 worker，它由源和路径组成。它可以控制它关联的网页，解释且修改导航，资源的请求，以及一种非常细粒度的方式来缓存资源以让你非常灵活地控制程序在某些情况下的行为（比如网络不可用）。

[<img width="1012" height="414" src="../../../_resources/e12fb356b1ca492a80bc588307349fe0.png"/>](https://user-images.githubusercontent.com/1475173/40270197-7267d41e-5bbb-11e8-9bd3-978cab346084.png)

Service Workers 浏览器支持情况

本篇文章，我们将会专注于 Dedicated Workers 并以 『Web Workers』或者 『Workers』来称呼它。

## <a id="user-content-web-workers-运行原理"></a>[](#web-workers-运行原理)Web Workers 运行原理
...
## <a id="user-content-web-worker-通信"></a>[](#web-worker-通信)Web Worker 通信
...
## <a id="user-content-postmessage-方法"></a>[](#postmessage-方法)postMessage 方法
...
## <a id="user-content-广播信道"></a>[](#广播信道)广播信道
...
[<img width="1012" height="759" src="../../../_resources/f2c2157eedde412794057a29612966a2.png"/>](https://user-images.githubusercontent.com/1475173/40270201-736e77d2-5bbb-11e8-9aa8-c8706a15f0e6.png)

所有的浏览器上下文都是同源的

然而，广播信道浏览器兼容性不太好：

[<img width="1012" height="415" src="../../../_resources/00b28c70427f4d698f83c359844d824c.png"/>](https://user-images.githubusercontent.com/1475173/40270202-73c75668-5bbb-11e8-8793-6f48bf059294.png)

## <a id="user-content-消息大小"></a>[](#消息大小)消息大小
...
## <a id="user-content-web-workers-的可用功能"></a>[](#web-workers-的可用功能)Web Workers 的可用功能
...
## <a id="user-content-web-worker-的局限性"></a>[](#web-worker-的局限性)Web Worker 的局限性
...
## <a id="user-content-web-workers-最佳使用场景"></a>[](#web-workers-最佳使用场景)Web Workers 最佳使用场景
