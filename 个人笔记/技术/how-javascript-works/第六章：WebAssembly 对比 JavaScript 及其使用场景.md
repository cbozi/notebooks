...
## <a id="user-content-首先认识下-webassembly-吧"></a>[](#首先认识下-webassembly-吧)首先，认识下 WebAssembly 吧
...
## <a id="user-content-加载时间"></a>[](#加载时间)加载时间
...
## <a id="user-content-执行速度"></a>[](#执行速度)执行速度
...
[<img width="1012" height="571" src="../../../_resources/93cfd8cbc21d4147bf751ce7115b0bea.png"/>](https://user-images.githubusercontent.com/1475173/40056004-8a3ec756-587c-11e8-87e5-23f21b3e4805.png)
...
[![](../../../_resources/d720d23dc7e1489485b459bb12680448.png)](https://user-images.githubusercontent.com/1475173/40056005-8a7d6920-587c-11e8-8b0b-2665efdd722a.png)
...
[![](../../../_resources/57c0d7c0bc634b2cb57275c820a081a4.png)](https://user-images.githubusercontent.com/1475173/40056008-8b0416dc-587c-11e8-9d5f-9263ae8a8d53.png)
...
## <a id="user-content-内存模型"></a>[](#内存模型)内存模型

[![](../../../_resources/cc4e8920a86d4012aaadc25c537f7202.png)](https://user-images.githubusercontent.com/1475173/40056007-8ac584b2-587c-11e8-9006-49c58276279f.png)
...
## <a id="user-content-内存垃圾回收"></a>[](#内存垃圾回收)内存垃圾回收
...
## <a id="user-content-平台接口访问"></a>[](#平台接口访问)平台接口访问
...
## <a id="user-content-源码映射"></a>[](#源码映射)源码映射
...
## <a id="user-content-多线程"></a>[](#多线程)多线程
...
## <a id="user-content-可移植性"></a>[](#可移植性)可移植性
...
## <a id="user-content-webassembly-使用场景"></a>[](#webassembly-使用场景)WebAssembly 使用场景
...
## <a id="user-content-番外篇"></a>[](#番外篇)番外篇
